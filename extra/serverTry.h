...
void *syncFileServ(void *arg) {
        ...
        char buffer[MAXRCVLEN+1], user[50], fileName[100], cmd[30];
        FILE *tmpFp;
        ...
        listen(addSock, 5);
        int t = bind(addSock, (struct sockaddr *)&dest, sizeof(struct sockaddr));
        lenSock = sizeof(struct sockaddr);

        printf("\n wpojwm23e0329x0x20e392ie,302e32e230ei230ie230   %d\n", t);
        while(1) {
                printf("\n INSIDE 999999 \n");
                ...
                if((len = recv(conSock, buffer, MAXRCVLEN, 0)) <= 0) {
                ...
                if(type == 1) {
                        ...
                        if(!strcmp(command, "rm")) {
                                ...
                                */
                                ...
                                sprintf(packet3, "3 %s %s YES", username);

                                printf("\n %s \n", packet3);
                                len = send(consocket, packet3, strlen(packet3), 0);
                                if(len < 0) {
                                        printf("\n ERROR \n");
                                }
